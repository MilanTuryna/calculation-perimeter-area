<?php
if ($_POST['rozmer1'] && $_POST['rozmer2']) {
	...
	<div class="row">
		<div class="col">
			<form style="user-select: none;">
				...
				<div class="form-group">
					<label for="formGroupExampleInput">Strana 2</label>
					<input type="number"  name="rozmer4"class="form-control" disabled id="formGroupExampleInput" placeholder="<?php echo("$b1")?>">
				</div>

				<div class="form-group">
					<input type="submit" style="pointer: default;" disabled class="btn btn-outline-info" value="Vypočítat"/>
				</div>
